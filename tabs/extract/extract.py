...
from rvc.lib.utils import load_audio_16k, load_embedding, get_embedder_dim
...
if __name__ == "__main__":
    ...
    embedder_dim = get_embedder_dim(chosen_embedder_model, custom_embedder=embedder_model_custom)
    print(f"Embedder: {chosen_embedder_model}, feature dim: {embedder_dim}")
    ...
    data["embedder_dim"] = embedder_dim
